...
## Add codes of interest to data set documentation at top
## Add better comments and clean up code
## Add IPW missing data example
...
bias.adjust.prob <- function(fmla,mu0,mu1,p0,link = "ident"){
  ...
  fitp = suppressMessages(gee(fmla,id = seq(1,nrow(data1)), fam = "gaussian", data = data1))
